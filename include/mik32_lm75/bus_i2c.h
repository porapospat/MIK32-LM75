 ...
 */
HAL_StatusTypeDef I2C_read_data(I2C_HandleTypeDef *hi2c, uint8_t device_addr, uint8_t reg_addr, uint8_t *data, uint16_t len);
 ...
 * @return            Статус операции записи
 */
HAL_StatusTypeDef I2C_write_data(I2C_HandleTypeDef *hi2c, uint8_t device_addr, uint8_t reg_addr, uint8_t *data, uint16_t len);
 ...
 * @return            Статус операции чтения
 */
HAL_StatusTypeDef I2C_read_byte(I2C_HandleTypeDef *hi2c, uint8_t device_addr, uint8_t reg_addr, uint8_t *data);
